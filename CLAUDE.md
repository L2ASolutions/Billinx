...
- 254 tests passing, 18 test suites, 45 DB models, 21 enums (payment + webhook + identity/auth module tests added 2026-07-04; was 83/5, unchanged since 2026-06-11, until then)
...
- Real coverage exists for: invoice-flow, XML builder, incoming-invoice, VAT service, and (added 2026-07-04) payment, webhook, and identity/auth (254 tests / 18 suites total).
...
- **Zero tests** for: tenant, user, admin, kyb, consent, product-catalog, export, reference-data, submission adapters, and the newer modules — client, analytics, inventory, notification, reminder.
