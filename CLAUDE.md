...
- **New, previously unflagged:** `invoices/[id]/page.tsx` planned as PR 3 (1,536 lines, was documented as 1,527). `purchases/page.tsx` — 851 lines. `payments/page.tsx` — 845 lines.
