...
- 352 tests passing, 21 test suites, 45 DB models, 21 enums (payment + webhook + identity/auth + user module tests added 2026-07-04; was 83/5, unchanged since 2026-06-11, until then)
...
- Real coverage exists for: invoice-flow, XML builder, incoming-invoice, VAT service, and (added 2026-07-04) payment, webhook, identity/auth, and user (352 tests / 21 suites total).
...
- **Zero tests** for: tenant, admin, kyb, consent, product-catalog, export, reference-data, submission adapters, and the newer modules — client, analytics, inventory, notification, reminder.
