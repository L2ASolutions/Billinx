...
- 153+ PRs merged to main (through PR #188 as of 2026-07-09; several since, including `feat/docs` Swagger/OpenAPI coverage, `feat/auth` API key scopes + per-key rate limiting, `chore/ui-cleanup-admin-actions`, and `feat/error-reporting` below)
...
- Last merged PRs: `feat/error-reporting` (this one), `test/e2e-playwright-tests`, `feat/recurring-invoices`, `chore/ui-cleanup-admin-actions`, `feat/api-key-scopes-rate-limiting`
